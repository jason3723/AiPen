...
// 通用样式
const selFont = 'h-7 bg-gray-800 border border-gray-700 rounded px-1.5 text-[11px] text-gray-200 focus:outline-none focus:border-blue-500 flex-1 min-w-0 appearance-none';
const selSize = 'h-7 bg-gray-800 border border-gray-700 rounded px-1 text-[11px] text-gray-200 focus:outline-none focus:border-blue-500 w-14 shrink-0 text-center appearance-none';
const labelSm = 'text-[10px] text-gray-500 shrink-0';
</script>
...
<template>
  <Teleport to="body">
    <div
      ...
      @click.self="cancel"
    >
      <div class="bg-gray-900 border border-gray-700 rounded-xl shadow-2xl w-[560px] max-h-[80vh] overflow-hidden flex flex-col">
        <!-- 标题栏 -->
        <div class="flex items-center justify-between px-5 py-3 border-b border-gray-700">
          <h3 class="text-sm font-semibold text-gray-200">导出 Word 设置</h3>
          <button
        ...
        <div class="flex-1 overflow-y-auto px-5 py-4 space-y-5">
          ...
          <section>
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-1.5">
                <span class="text-[11px] text-gray-500 w-6 shrink-0">H1</span>
                <span :class="labelSm">字体</span>
                <select v-model="local.fontH1" :class="selFont">
                  <option v-for="f in fontOptions" :key="f" :value="f" class="bg-gray-800 text-gray-200">{{ f }}</option>
                </select>
                <span :class="labelSm">字号</span>
                <select v-model.number="local.sizeH1" :class="selSize">
                  <option v-for="s in fontSizeOptions" :key="s.label" :value="s.pt" class="bg-gray-800 text-gray-200">{{ s.label }}</option>
                </select>
                ...
                <label class="flex items-center cursor-pointer select-none shrink-0">
                  ...
                  <span class="w-8 h-5 rounded-full transition-colors inline-flex items-center px-0.5" :class="local.boldH1 ? 'bg-blue-600' : 'bg-gray-600'">
              ...
              <!-- H2 -->
              <div class="flex items-center gap-1.5">
                <span class="text-[11px] text-gray-500 w-6 shrink-0">H2</span>
                <span :class="labelSm">字体</span>
                ...
                <label class="flex items-center cursor-pointer select-none shrink-0">
                  ...
                  <span class="w-8 h-5 rounded-full transition-colors inline-flex items-center px-0.5" :class="local.boldH2 ? 'bg-blue-600' : 'bg-gray-600'">
              ...
              <!-- H3 -->
              <div class="flex items-center gap-1.5">
                <span class="text-[11px] text-gray-500 w-6 shrink-0">H3</span>
                <span :class="labelSm">字体</span>
                ...
                <label class="flex items-center cursor-pointer select-none shrink-0">
                  ...
                  <span class="w-8 h-5 rounded-full transition-colors inline-flex items-center px-0.5" :class="local.boldH3 ? 'bg-blue-600' : 'bg-gray-600'">
              ...
              <!-- H4 -->
              <div class="flex items-center gap-1.5">
                <span class="text-[11px] text-gray-500 w-6 shrink-0">H4</span>
                <span :class="labelSm">字体</span>
                ...
                <label class="flex items-center cursor-pointer select-none shrink-0">
                  ...
                  <span class="w-8 h-5 rounded-full transition-colors inline-flex items-center px-0.5" :class="local.boldH4 ? 'bg-blue-600' : 'bg-gray-600'">
              ...
              <!-- 正文 -->
              <div class="flex items-center gap-1.5">
                <span class="text-[11px] text-gray-500 w-6 shrink-0">正文</span>
                <span :class="labelSm">字体</span>
                ...
                <label class="flex items-center cursor-pointer select-none shrink-0">
                  ...
                  <span class="w-8 h-5 rounded-full transition-colors inline-flex items-center px-0.5" :class="local.boldBody ? 'bg-blue-600' : 'bg-gray-600'">
          ...
          <section>
            ...
            <div class="grid grid-cols-4 gap-3">
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">上</span>
                <input
                  v-model.number="local.marginTop"
                  type="number" step="0.1" min="0" max="100"
                  class="h-7 bg-gray-800 border border-gray-700 rounded px-2 text-xs text-gray-200 focus:outline-none focus:border-blue-500"
                />
              </label>
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">下</span>
                <input
              ...
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">左</span>
                <input
              ...
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">右</span>
                <input
          ...
          <section>
            ...
            <div class="grid grid-cols-3 gap-3">
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">每行字数</span>
                <input
              ...
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">每页行数</span>
                <input
              ...
              <label class="flex flex-col gap-1">
                <span class="text-[11px] text-gray-500">行间距 (pt)</span>
                <input
          ...
          <section>
            ...
            <div class="flex gap-3">
              <label class="flex flex-col gap-1 flex-1">
                <span class="text-[11px] text-gray-500">页眉</span>
                <input
              ...
              <label class="flex flex-col gap-1 flex-1">
                <span class="text-[11px] text-gray-500">页脚</span>
                <input
        ...
        <div class="flex items-center justify-between px-5 py-3 border-t border-gray-700">
          ...
          <div class="flex items-center gap-2">
            <button
              class="h-7 px-4 bg-gray-700 hover:bg-gray-600 text-gray-300 text-xs rounded transition-colors"
              @click="cancel"
            >
              取消
            </button>
